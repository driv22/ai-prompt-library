    ...
    <footer style={{ backgroundColor: 'var(--bg-surface)', borderTop: '1px solid var(--border)', padding: '3rem 1.5rem', marginTop: '6rem' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', textAlign: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
          ...
          <span style={{ fontFamily: 'var(--font-outfit)', fontWeight: 700, color: 'var(--text-primary)' }}>AI Prompt Library</span>
        </div>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem', marginBottom: '1rem' }}>250 enterprise-grade AI prompts for Microsoft 365 Copilot.</p>
